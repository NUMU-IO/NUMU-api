...
metadata:
  ...
  source: red-team:commands/red-team-gate.md
---
...
2. **Scan the spec for Red Team Trigger Criteria**.
   ...
   | `ai_llm` | `LLM`, `Codex`, `GPT`, `prompt`, `inference`, `classification`, `extraction`, `summarisation`, `summarization`, `scoring`, `model output`, `AI-generated`, `AI-assisted` |
