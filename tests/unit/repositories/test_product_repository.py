...
class TestProductRepository:
    ...
    async def test_get_by_id_found(self):
        ...
        mock_model.sale_price = None
        mock_model.sale_starts_at = None
        mock_model.sale_ends_at = None
        mock_model.requires_shipping = True
        mock_model.tax_exempt = False
        mock_model.related_product_ids = None
        ...
        mock_model.robots_noindex = False
        mock_model.canonical_url = None
        mock_model.sitemap_exclude = False
