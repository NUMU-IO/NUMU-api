...
# Backwards-compat alias — prior code in this module called the
# inline helper. The implementation now lives in the shared
# meta_capi_purchase_dispatcher so all payment-method handlers (Paymob,
# Fawry, Fawaterak, Instapay, Kashier, COD) ship one identical CAPI
# payload shape and one identical activation gate.
