    ...
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:0 auto;">
      <tr>
        <td align="center" style="text-align:center;padding-bottom:4px;">
          <span style="font-family:{FONT_BRAND_AR},'Traditional Arabic',serif;font-size:38px;font-weight:700;color:#ffffff;line-height:1.2;display:inline-block;">نُمو</span>
          <br>
          <span style="font-family:{FONT_LATIN};font-size:11px;font-weight:600;color:{GOLD};letter-spacing:4px;text-transform:uppercase;display:inline-block;margin-top:2px;">NUMU</span>
        </td>
      </tr>
    </table>
    """
...
def header(
    ...
    badge_html = (
        f'<table role="presentation" cellpadding="0" cellspacing="0" border="0" align="center" style="margin:14px auto 0;">'
        f'<tr><td align="center" style="background-color:#2a2a3d;color:{GOLD};'
        f"border:1px solid {GOLD_DARK};font-size:12px;padding:5px 14px;"
        f"border-radius:4px;font-weight:600;letter-spacing:0.5px;"
        f'font-family:{FONT_LATIN};direction:ltr;mso-line-height-rule:exactly;">{badge}</td></tr></table>'
        if badge
        else ""
    )

    sub_html = (
        f'<p style="color:#9ca3af;margin:6px 0 0;font-size:14px;font-family:{font_family};mso-line-height-rule:exactly;">{subtitle}</p>'
        if subtitle
        else ""
    )
    ...
    return f"""
    <!--[if mso]>
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" style="background-color:{HERO_BG};"><tr><td align="center" style="padding:32px 28px 0;">
    <![endif]-->
    <table role="presentation" width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="{HERO_BG}" class="gmail-fix" style="background-color:{HERO_BG};">
      ...
      <tr>
        <td height="3" style="height:3px;line-height:3px;font-size:1px;background-color:{GOLD};mso-line-height-rule:exactly;">&nbsp;</td>
      </tr>
    </table>
    <!--[if mso]>
    </td></tr></table>
