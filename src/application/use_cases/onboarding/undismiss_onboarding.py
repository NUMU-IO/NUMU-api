"""Undismiss (restore) onboarding use case."""
...
class UndismissOnboardingUseCase:
    """Use case for restoring a previously dismissed onboarding."""
    ...
    async def execute(
        ...
        """Undismiss the onboarding for a store.
