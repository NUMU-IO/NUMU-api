...
async def partner_statement(
    ...
    + payouts``. Sales: what merchants paid before VAT (gross, after the
    partner's coupons), NUMU's fee and the partner's share (net) at the
    share each sale was booked with. Refunds reverse a sale's share. Coupon
    discounts and NUMU's VAT are informational: VAT is NUMU's, on its fee,
    and never touches the partner's balance."""
